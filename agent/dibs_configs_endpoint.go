...
func (s *HTTPHandlers) DibsJsonConfigs(resp http.ResponseWriter, req *http.Request) (interface{}, error) {
	return s.doDibsConfigs(resp, req, requestTypeJsonConfigs)
}

func (s *HTTPHandlers) DibsConfigFiles(resp http.ResponseWriter, req *http.Request) (interface{}, error) {
	return s.doDibsConfigs(resp, req, requestTypeConfigFiles)
}

func (s *HTTPHandlers) doDibsConfigs(resp http.ResponseWriter, req *http.Request, requestType requestType) (interface{}, error) {
...
func (s *HTTPHandlers) getSchema(currentVersion string) (map[string]map[string]interface{}, error) {
...
func (s *HTTPHandlers) getConfigs(currentVersion, service string, buckets []string, tokensWithValues map[string]string) (map[string]string, error) {
...
func (s *HTTPHandlers) getValue(key string) (string, error) {
...
func (s *HTTPHandlers) getValues(prefix string) (map[string]string, error) {
	args := structs.KeyRequest{
		Datacenter: "dibs-consul",
		Key:        prefix,
	}
